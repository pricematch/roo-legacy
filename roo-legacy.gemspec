...
Gem::Specification.new do |s|
  ...
  s.date = "2013-12-23"
  s.description = "RooLegacy can access the contents of various spreadsheet files. It can handle\n* OpenOffice\n* Excel\n* Google spreadsheets\n* Excelx\n* LibreOffice\n* CSV"
  ...
  s.files = [
    ...
    "lib/roo_legacy.rb",
    "lib/roo_legacy/base.rb",
    "lib/roo_legacy/csv.rb",
    "lib/roo_legacy/excel.rb",
    "lib/roo_legacy/excel2003xml.rb",
    "lib/roo_legacy/excelx.rb",
    "lib/roo_legacy/google.rb",
    "lib/roo_legacy/openoffice.rb",
    ...
    "spec/lib/roo_legacy/base_spec.rb",
    "spec/lib/roo_legacy/csv_spec.rb",
    "spec/lib/roo_legacy/excel2003xml_spec.rb",
    "spec/lib/roo_legacy/excel_spec.rb",
    "spec/lib/roo_legacy/excelx/format_spec.rb",
    "spec/lib/roo_legacy/excelx_spec.rb",
    "spec/lib/roo_legacy/google_spec.rb",
    "spec/lib/roo_legacy/libreoffice_spec.rb",
    "spec/lib/roo_legacy/openoffice_spec.rb",
    "spec/lib/roo_legacy/spreadsheet_spec.rb",
    "spec/spec_helper.rb",
    "test/all_ss.rb",
  ...
  s.summary = "RooLegacy can access the contents of various spreadsheet files."
